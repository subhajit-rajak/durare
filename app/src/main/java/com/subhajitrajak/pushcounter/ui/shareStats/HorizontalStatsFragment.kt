...
import com.subhajitrajak.pushcounter.databinding.FragmentHorizontalStatsBinding

class HorizontalStatsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHorizontalStatsBinding.inflate(inflater, container, false)
        return binding.root
    }
